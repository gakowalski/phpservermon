...
$sm_lang = array(
	...
	'environment' => array(
        'delete_title' => 'Delete Environment',
        'delete_message' => 'Are you sure you want to delete Environment \'%1\'?',
        'deleted' => 'Environment deleted.',
        'updated' => 'Environment updated.',
        'inserted' => 'Environment added.',
        'error_environment_no_match' => 'Environment not found.',
        'delete_error' => 'Environment has server.',
        'error_environment_name_bad_length' => 'The name must be between 1 and 45 characters.',
        'error_environment_name_already_taken' => 'The name already taken.',
